...
public class Datos_Cliente extends JFrame {
	...
	public Datos_Cliente(String userName, Cliente cliente) {
		...
		JLabel lblNewLabel = new JLabel(texts.getLabelDatosCliente());
		...
		JLabel lblUsuario = new JLabel(texts.getLabelUsuario() + userName);
		...
		JLabel lblNombre = new JLabel(texts.getLabelNombre());
		...
		JLabel lblPrimerApellido = new JLabel(texts.getLabelPrimerApellido());
		...
		JLabel lblSegundoApellido = new JLabel(texts.getLabelSegundoApellido());
		...
		JLabel lblDireccin = new JLabel(texts.getLabelDireccion());
		...
		JLabel lblCorreoElectrnico = new JLabel(texts.getLabelCorreo());
		...
		JLabel lblGnero = new JLabel(texts.getLabelGenero());
		...
		rdbtnHombre = new JRadioButton(texts.getRbHombre());
		...
		rdbtnMujer = new JRadioButton(texts.getRbMujer());
		...
		rdbtnNewRadioButton = new JRadioButton(texts.getRbNoDeterminado());
		...
		JLabel lblFechaNacimiento = new JLabel(texts.getLabelFecha());
		...
		JButton btnGuardar = new JButton(texts.getBotonGuardar());
		...
		JButton btnSiguiente = new JButton(texts.getBotonSiguiente());
	...
	private boolean comprobar() {
        if (campo_Nombre.getText().isEmpty() || campo_PrimerApellido.getText().isEmpty()
            ...
            JOptionPane.showMessageDialog(null, texts.getIntroRequired());
            return false;
        } else if (!email()) {
            return false;
        }
	...
	private boolean email() {
        ...
        JOptionPane.showMessageDialog(null, texts.getIncorrectEmail());
        return false;
    }
