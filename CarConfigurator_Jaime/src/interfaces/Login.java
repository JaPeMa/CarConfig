...
public class Login extends JFrame {
	 ...
	 */
	public Login() {
		texts = LectorLanguage.getLanguage();
		...
		JLabel lblLogin = new JLabel(texts.getLogin());
		...
		JLabel lblPassword = new JLabel(texts.getPassword());
		...
		JButton btnEntrar = new JButton(texts.getEnter());
	...
	private void comprobacion() {
        ...
        if (!correcto) {
            JOptionPane.showMessageDialog(null, texts.getInvalidLogin());
        }
    }
                    ...
                    if (datos.get(1).equals(user)) {
                        ...
                        if (datos.size() > 2 && confirmarCarga()) {
                            ...
                            case 4:
                                ...
                                ModeloCoche.main(obtenerCliente(datos));
                                break;
case 5:
                                fichero_temporal_borrar();
                                selec_model.main(idCoche(datos), obtenerCliente(datos));
                                break;
